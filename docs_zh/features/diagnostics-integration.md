---
description: 利用 Roo Code 与 VSCode 问题面板的集成，自动检测、理解和修复代码错误、警告和代码检查问题。
keywords:
  - 诊断集成
  - 错误检测
  - 问题面板
...
有关 `@problems` 的更多详细信息，请参阅 [上下文提及](/basic-usage/context-mentions#problems-mention)。
...
有关此集成的更多信息，请参阅 [代码操作](/features/code-actions#context-aware-actions)。
...
### 代码操作
诊断为上下文感知的 [代码操作](/features/code-actions) 提供支持，这些操作出现在 VSCode 的灯泡菜单中。当存在错误时，您会看到"修复代码"选项，其中包含特定的诊断信息。

### 上下文提及
[`@problems` 提及](/basic-usage/context-mentions#problems-mention) 提供了一种方便的方法，将所有工作区诊断包含在对话中，而无需手动复制错误消息。
...
- [上下文提及](/basic-usage/context-mentions) - 了解所有提及类型，包括 `@problems`
- [代码操作](/features/code-actions) - 了解诊断如何与快速修复集成
