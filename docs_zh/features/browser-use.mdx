---
description: 了解 Roo Code 如何控制浏览器以自动化网页任务、收集信息并与 Web 应用交互，借助 AI 驱动的浏览器自动化功能。
keywords:
  - browser automation
  - web scraping
  - browser control
...
更改此设置：
1. 在浏览器/计算机使用设置中，勾选或取消勾选"启用浏览器工具"复选框
...
更改此设置：
1. 在浏览器/计算机使用设置中，调整"屏幕截图质量"滑块
2. 将值设置为 1-100% 之间（默认为 75%）
