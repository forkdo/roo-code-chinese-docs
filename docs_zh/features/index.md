---
description: '探索 Roo Code 的所有功能，包括 AI 驱动的编码辅助、多文件编辑、代码库索引、MCP 集成、自定义模式和实验性功能。'
keywords:
  - Roo Code features
  - AI coding assistant
  - code editing
...
探索 Roo Code 的强大功能，它将成为您终极的 AI 驱动编码助手。从智能代码编辑到高级集成，Roo Code 能够增强您的开发工作流程。
...
- [**增强提示**](/features/enhance-prompt) - 自动优化您的提示以获得更好的结果
- [**建议回复**](/features/suggested-responses) - 基于上下文的后续建议
...
- [**自定义模式**](/features/custom-modes) - 为特定工作流创建专门的 AI 助手

### 配置与自定义
- [**API 配置配置文件**](/features/api-configuration-profiles) - 管理多个 API 配置
- [**自定义指令**](/features/custom-instructions) - 个性化 AI 行为
- [**Skills**](/features/skills) - 创建可重用的任务特定指令包
...
- [**浏览器使用**](/features/browser-use) - 网页自动化和交互功能
...
- [**自定义工具**](/features/experimental/custom-tools) - 定义 Roo 可以调用的 TypeScript/JavaScript 工具
- [**并发文件编辑**](/features/experimental/concurrent-file-edits) - 在单个操作中编辑多个文件
- [**更多实验性功能**](/features/experimental/experimental-features) - 探索正在开发中的功能

## 其他资源

- [**更多功能**](/features/more-features) - 发现其他功能
- [**提示与技巧**](/tips-and-tricks) - 充分利用 Roo Code
- [**常见问题**](/faq) - 常见问题解答

---

准备好探索了吗？从我们的[入门指南](/getting-started/installing)开始，或者深入了解您感兴趣的任何功能！