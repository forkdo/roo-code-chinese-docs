...
description: 在 Roo Code 中配置 DeepSeek 的聊天和推理模型。访问 deepseek-chat 和 deepseek-reasoner 进行编码和复杂推理任务。
keywords:
  - deepseek
  - deepseek chat
  - deepseek reasoner
...
1.  **注册/登录：** 访问 [DeepSeek 平台](https://platform.deepseek.com/)。创建账户或登录。
...
4.  **复制密钥：**  **重要：** 请*立即*复制 API 密钥。您将无法再次查看它。请安全存储。

---

## 可用模型

Roo Code 支持通过 DeepSeek API 提供的所有模型。

有关完整且最新的模型列表，请参阅 [DeepSeek 的 API 文档](https://api-docs.deepseek.com/quick_start/pricing)。
